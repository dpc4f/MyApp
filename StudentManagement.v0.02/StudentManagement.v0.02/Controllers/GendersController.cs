...
using StudentManagement.v0._02.Models;
using StudentManagement.v0._02.Reports;

namespace StudentManagement.v0._02.Views
{
    public class GendersController : Controller
    {
        private StudentMgtDataEntities db = new StudentMgtDataEntities();
        ...
        public ActionResult ViewReport()
        {
            ...
            GenderSummary rpt = new GenderSummary();
