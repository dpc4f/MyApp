...
namespace StudentManagement.v0._03.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idStudent,FirstName,MiddleName,LastName,idGender,idDept,idTitle")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idStudent,FirstName,MiddleName,LastName,idGender,idDept,idTitle")] Student student)
        {
            if (ModelState.IsValid)
            {
