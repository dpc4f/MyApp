...
begin
	...
	*/
	...
	begin
		...
		-- get the subject id, subject number
		...
		set @idEnrollment = 'ENRO.' + dbo.fn_ZeroPad(@nSbjNumber, 4) + '.' 
									+ dbo.fn_ZeroPad(@nStudNumber, 6) + '.' + cast(@nEntrYear as varchar(50)) + '.1' 
		print @idEnrollment
